...
predbrt1=predict(brt.a1, 
                 ...
                 type="response") 
plot(predbrt1, subset(binded, AGE == 1)[predset1,8]) #predicted lengths vs observed 

summary(lm(subset(binded, AGE == 1)[predset1,8] ~ predbrt1))


#### Age 2 #### 
brt.a2 = gbm.step(data = subset(binded, AGE == 2), gbm.x = xx.list, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                  n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
brt.a2simp = gbm.step(data = subset(binded, AGE == 2), gbm.x = xlist_simp2, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                      n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
plot(predbrt2,subset(binded, AGE == 2)[predset2,8])

summary(lm(subset(binded, AGE == 2)[predset2,8] ~ predbrt2))
####


### Age3 ####
brt.a3 = gbm.step(data = subset(binded, AGE == 3), gbm.x = xx.list, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                  n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
brt.a3simp = gbm.step(data = subset(binded, AGE == 3), gbm.x = xlist_simp3, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                      n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
plot(predbrt3,subset(binded, AGE == 3)[predset3,8])

summary(lm(subset(binded, AGE == 3)[predset3,8] ~ predbrt3))
###


### Age 4 #### 

brt.a4 = gbm.step(data = subset(binded, AGE == 4), gbm.x = xx.list, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                  n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
brt.a4simp = gbm.step(data = subset(binded, AGE == 4), gbm.x = xlist_simp4, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                      n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
plot(predbrt4,subset(binded, AGE == 4)[predset4,8])

summary(lm(subset(binded, AGE == 4)[predset4,8] ~ predbrt4))



### Age 5 ####
brt.a5 = gbm.step(data = subset(binded, AGE == 5), gbm.x = xx.list, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                  n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
brt.a5simp = gbm.step(data = subset(binded, AGE == 5), gbm.x = xlist_simp5, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                      n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
plot(predbrt5,subset(binded, AGE == 5)[predset5,8])

summary(lm(subset(binded, AGE == 5)[predset5,8] ~ predbrt5))
###

### Age 6 ####
brt.a6 = gbm.step(data = subset(binded, AGE == 6), gbm.x = xx.list, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                  n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
brt.a6simp = gbm.step(data = subset(binded, AGE == 6), gbm.x = xlist_simp6, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                      n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
plot(predbrt6,subset(binded, AGE == 6)[predset6,8])

summary(lm(subset(binded, AGE == 6)[predset6,8] ~ predbrt6))
###

### Age 7 ####
brt.a7 = gbm.step(data = subset(binded, AGE == 7), gbm.x = xx.list, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                  n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
brt.a7simp = gbm.step(data = subset(binded, AGE == 7), gbm.x = xlist_simp7, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                      n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
plot(predbrt7,subset(binded, AGE == 7)[predset7,8])

summary(lm(subset(binded, AGE == 7)[predset7,8] ~ predbrt7))
###

### Age 8 #### 
brt.a8 = gbm.step(data = subset(binded, AGE == 8), gbm.x = xx.list, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                  n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
brt.a8simp = gbm.step(data = subset(binded, AGE == 8), gbm.x = xlist_simp8, gbm.y = 8, family = "gaussian", tree.complexity = 5, learning.rate = 0.001, bag.fraction = 0.5,
                      n.folds = 10, n.trees = 50, step.size = 100, max.trees = 1000000, tolerance = 0.001)
...
plot(predbrt8,subset(binded, AGE == 8)[predset8,8])

summary(lm(subset(binded, AGE == 8)[predset8,8] ~ predbrt8))